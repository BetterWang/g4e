...
JLeicXTRphysics::JLeicXTRphysics(JLeicDetectorConstruction* p, JLeicPhysicsList* pl, const G4String& name)
:  G4VPhysicsConstructor(name), fJLeicXTRphysicsMessenger(0)
{
  pDet = p;
  pList= pl;
  SetXTRModel("none");
