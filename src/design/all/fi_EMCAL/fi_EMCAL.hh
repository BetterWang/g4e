...
#ifndef G4E_FI_EMCAL_HH
#define G4E_FI_EMCAL_HH
...
class fi_EMCAL_Design {
public:
    inline void Construct(fi_EMCAL_Config cfg, G4Material *worldMaterial, G4VPhysicalVolume *motherVolume) {
        printf("Begin fi_EMCAL volume \n");
        static char abname[256];
        ConstructionConfig = cfg;
        // create  a global volume for your detectors
        // ce_EMCAL_det_Material= fMat->GetMaterial("DSBCe");
        G4Material *fi_EMCAL_Material = G4Material::GetMaterial("PbWO4");
 ...
 //============  For sectors =====
    ...
    inline void ConstructDetectors() {
        printf("Begin fi_EMCAL detector volumes \n");
    ...
    fi_EMCAL_Config  ConstructionConfig;
