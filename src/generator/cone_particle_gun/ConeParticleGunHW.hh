...
#ifndef G4E_ConeParticleGunHW_h
#define G4E_ConeParticleGunHW_h 1
...
// particle. But, ConeParticleGunHW does NOT have any way of randomization. Instead, the user's
...
public: // with description
	...
	void SetParticleMinMomentum(G4double aMomentum);
	void SetParticleMaxMomentum(G4double aMomentum);
	
	void SetParticleMinEta(G4double aPseudorap);
	void SetParticleMaxEta(G4double aPseudorap);
...
protected:
    ...
    G4double particle_minMomentum;
    G4double particle_maxMomentum;
    
    G4double particle_minEta;
    G4double particle_maxEta;
