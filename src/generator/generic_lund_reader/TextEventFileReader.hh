...
namespace g4e {
    ...
    public:
         ...
         */
        using LineRecognisionFunc = TextEventLineDecisions (*)(uint64_t line_num, const std::string& line);

        /**
         * This function is provided by user to decide what to do:
         * when the line is tokenized
         */
        using TokensRecognisionFunc = TextEventLineDecisions (*)(uint64_t line_num, const std::vector<std::string>& tokens);
