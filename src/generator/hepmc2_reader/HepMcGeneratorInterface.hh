...
/// An interface (base class) for primary generation via HepMC.
/// This class is derived from G4VPrimaryGenerator.
/// The class covers the idea, that concrete classes provide:
///     HepMC::GenEvent *GenerateHepMCEvent()
/// Example of a subclass is @see: HepMCAsciiReader, which reads an ascii version of hepmc
...
public:
    ...
    virtual HepMC::GenEvent *GenerateHepMCEvent() = 0;

    inline void SetVerboseLevel(G4int i) {
        fVerbose = i;
    }
    ...
    HepMcGeneratorInterface();
    ~HepMcGeneratorInterface() override;
