...
void BeamlineConstruction::Create_ci_Endcap(DetectorConfig::ci_Endcap_Config cfg)
{
...
void BeamlineConstruction::Create_ce_Endcap(DetectorConfig::ce_Endcap_Config cfg)
{
...
void BeamlineConstruction::SetUpJLEIC2019()
{
    ...
    if(beamLineName != "ip6" && beamLineName != "ip8") {
