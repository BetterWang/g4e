    ...
    fConfig(config)
{
    ...
    fMessenger = new G4GenericMessenger(this, "/eic/subdetector/", "EIC Single subdetector construction messenger");
...
G4VPhysicalVolume *SingleSubdetectorConstruction::Construct_ci_DIRC() {
