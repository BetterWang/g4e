...
//
G4ThreadLocal G4Allocator<JLeicCe_emcalDigiHit>* JLeicCe_emcalDigiHitAllocator = nullptr;


JLeicCe_emcalDigiHit::JLeicCe_emcalDigiHit()
{

}

JLeicCe_emcalDigiHit::~JLeicCe_emcalDigiHit() = default;
...
const JLeicCe_emcalDigiHit& JLeicCe_emcalDigiHit::operator=(const JLeicCe_emcalDigiHit& right)
{

  return *this;
}

JLeicCe_emcalDigiHit* JLeicCe_emcalDigiHit::JLeicCe_emcalDigi(JLeicCe_emcalHit* aHit){

    JLeicCe_emcalDigiHit *dHit = new JLeicCe_emcalDigiHit()  ;
    double ADC_crs;
...
JLeicCe_emcalDigiHit::JLeicCe_emcalDigiHit(int aHit){
...
double JLeicCe_emcalDigiHit::BirksAttenuation(double destep, double stepl, int charge, double birks) {
...
double* JLeicCe_emcalDigiHit::WaveFormPbwo(double npe, double* time_pbwo) {
    double c = exp(-2.);
   //    double Time;
...
void JLeicCe_emcalDigiHit::Print()
{;}
