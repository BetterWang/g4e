...
ci_TRD_Messenger::ci_TRD_Messenger(ci_TRD_Design *trdDesign) : G4UImessenger(),
                                                               fTrd(trdDesign)
{
    TRDdetDir = new G4UIdirectory("/eic/ci_TRD/");
    TRDdetDir->SetGuidance("TRD detector control.");

    RadiatorMaterCmd = new G4UIcmdWithAString("/eic/ci_TRD/setRadMat", this);
    ...
    ModelCmd = new G4UIcmdWithAnInteger("/eic/ci_TRD/setModel", this);
    ...
    FoilNumCmd = new G4UIcmdWithAnInteger("/eic/ci_TRD/setFoilNum", this);
    ...
    AbsThickCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/setAbsThick", this);
    ...
    RadiatorThickCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/setRadThick", this);
    ...
    GasGapThickCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/setGasGapThick", this);
    ...
    AbsRadCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/setAbsRad", this);
    ...
    AbsZposCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/setAbsZpos", this);
    ...
    cutGCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/cutG", this);
    ...
    cutECmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/cutE", this);
    ...
    setMaxStepCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/setMaxStep", this);
    ...
    ElectronCutCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/setElectronCut", this);
    ...
    PositronCutCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/setPositronCut", this);
    ...
    GammaCutCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/setGammaCut", this);
    ...
    RadiatorCutCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/setRadiatorCuts", this);
    ...
    DetectorCutCmd = new G4UIcmdWithADoubleAndUnit("/eic/ci_TRD/setDetectorCuts", this);
    ...
    XTRModelCmd = new G4UIcmdWithAString("/eic/ci_TRD/setXTRModel", this);
