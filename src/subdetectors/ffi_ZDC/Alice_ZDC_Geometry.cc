...
// Modifed by Quan Wang for EIC ZDC
...
G4VPhysicalVolume* Geometry::ConstructZDC(G4VPhysicalVolume *physVol_World) {
    ...
    //PAD layer
    std::cout << " !! --> PAD_MiniFoCal_X = " << PAD_MiniFoCal_X << " PAD_MiniFoCal_Y = " << PAD_MiniFoCal_Y << " PAD_Absorber_Z = " << PAD_Absorber_Z << " PAD_Glue1_Z = " << PAD_Glue1_Z << " PAD_Glue2_Z = " << PAD_Glue2_Z << " PAD_FPC_Z = " << PAD_FPC_Z << std::endl;
    std::cout << " !! --> PAD_X = " << PAD_X << " PAD_Y = " << PAD_Y << " PAD_Z = " << PAD_Z << std::endl;
    ...
    //PIX layer
    std::cout << " !! --> PIX_MiniFoCal_X = " << PIX_MiniFoCal_X << " PIX_MiniFoCal_Y = " << PIX_MiniFoCal_Y << " PIX_Absorber_Z = " << PIX_Absorber_Z << " PIX_Glue1_Z = " << PIX_Glue1_Z << " PIX_Glue2_Z = " << PIX_Glue2_Z << " PIX_FPC_Z = " << PIX_FPC_Z << std::endl;
    std::cout << " !! --> PIX_X = " << PIX_X << " PIX_Y = " << PIX_Y << " PIX_Z = " << PIX_Z << std::endl;
    ...
    //HCal tower
    std::cout << " !! --> HCAL_X_Tower = " << HCAL_X_Tower << " HCAL_Y_Tower = " << HCAL_Y_Tower << " HCAL_Z_Absorber = " << HCAL_Z_Absorber << " HCAL_Z_Scintilator = " << HCAL_Z_Scintilator << " HCAL_Z_Gap = " << HCAL_Z_Gap << std::endl;
    ...
    std::cout << " --> mat tungsten start" << std::endl;
    G4Material* material_tungsten = new G4Material("tungsten",18.73 *g/cm3,3);
    std::cout << " --> mat tungsten end" << std::endl;
    ...
    std::cout << " --> " << PAD_Layer_Thickness << "  " << PIX_Layer_Thickness << std::endl;
    for(G4int ilayer=0; ilayer<NumberOfLayers; ilayer++){
        ...
        if(LayerLayout[ilayer] == 0){
            ...
            std::cout << "  --> " << ilayer << " PAD " << position_Z_PAD_Silicon << "  " << TotalLayerThickness << std::endl;
