...
public:
    ...
    //------------Volume -----------
    G4Polycone *f_SolidBeamCone;    //pointer to the solid World
    G4LogicalVolume *f_LogicBeamCone;    //pointer to the logical World
    G4VPhysicalVolume *f_PhysicsBeamCone;    //pointer to the physical World

    G4Polycone *f_SolidBeamConeAl;    //pointer to the solid World
    G4LogicalVolume *f_LogicBeamConeAl;    //pointer to the logical World
    G4VPhysicalVolume *f_PhysicsBeamConeAl;    //pointer to the physical World
 ...
 //      G4double Z_cone[4]={ 0.*cm,  0.*cm,  (SizeZ/2),  (SizeZ/2)};
       ...
       G4double Z_cone[4]={ cfg.SizeZ/2.+cfg.f_ShiftZ, cfg.SizeZ/2.+cfg.f_ShiftZ , cfg.SizeZ/2.+ (cfg.f_SizeZ)+cfg.f_ShiftZ,  cfg.SizeZ/2.+(cfg.f_SizeZ)+cfg.f_ShiftZ};
      //World_ShiftVTX
       // Z1=  fBeamSizeZ_Be
    ...
    //  cfg.f_Xpos=-cfg.f_Rout1*2.;
       ...
       f_PhysicsBeamCone = new G4PVPlacement(G4Transform3D(bpr1, G4ThreeVector(cfg.f_Xpos,cfg.f_Ypos,cfg.f_Zpos)), "ir_Beampipe_f_Cone_Phys",f_LogicBeamCone,
